                    ...
                    <div class="col-lg-12">
                        <div class="card-body">
                            ...
                            <div class="col-lg-3 form-group">
                                ...
                                <span class="fa fa-asterisk"></span>
                                <select name="village" class="form-control select2" id="village_select_box" select-triger="cardno_select_box" select2="true" onchange="callAjax(this,'{{ route('admin.report.duplicate.voter.cardno') }}'+'?village_id='+this.value+'&district_id='+$('#district_select_box').val(),'cardno_select_box')">
                                    <option selected disabled>Select Panchayat / MC's</option>
                                    
                                </select>
                            </div>
                            <div class="col-lg-12 form-group">
                                <label for="exampleInputEmail1">Duplicate Voter Card No.</label>
                                <span class="fa fa-asterisk"></span>
                                <select name="voter_card_no" class="form-control select2" id="cardno_select_box" select2="true" onchange="callAjax(this,'{{ route('admin.report.duplicate.voter.table') }}'+'?voter_card_no='+this.value+'&village_id='+$('#village_select_box').val(),'value_div_id')">
                                    <option selected disabled>Duplicate Voter Card No.</option>
