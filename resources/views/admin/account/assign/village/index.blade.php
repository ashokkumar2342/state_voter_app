        ...
        <form action="{{ route('admin.Master.DistrictBlockVillageAssignStore') }}" no-reset="true" method="post" class="add_form" select-triger="user_id">
          ...
          <div class="row"> 
            <div class="col-md-12"> 
              ...
              <select class="form-control select2"  duallistbox="true" data-table-all-record="class_section_list" name="user" id="user_id"  onchange="callAjax(this,'{{route('admin.account.DistrictBlockVillageAssign')}}'+'?id='+this.value,'state_select_box')" > 
