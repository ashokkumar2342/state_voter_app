    ...
    <div class="container-fluid">
        ...
        <div class="card card-info"> 
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-12">
                            <form action="{{ route('admin.Master.add.voter.ward.submit') }}" method="post" no-reset="true" class="add_form" reset-input-text="from_sr_no,to_sr_no" select-triger="from_ward_select_box">
                                {{ csrf_field() }}
                                <div class="card-body">
                                    <div class="row"> 
                                    ...
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <span class="fa fa-asterisk"></span>
                                        <select name="village" class="form-control select2" id="village_select_box" select2="true" onchange="callAjax(this,'{{ route('admin.Master.add.voter.ward.showform') }}','value_div_id')">
