<div class="modal-dialog modal-lg">
  <div class="modal-content">
    ...
    <form action="{{ route('admin.mark.modification.voter.report.generate') }}" method="post" target="blank">
        {{ csrf_field() }} 
        <div class="row"> 
          ...
          <div class="col-lg-6 form-group"> 
            <div class="icheck-primary d-inline">
              ...
              <label for="radioPrimary1">Voter Not Modified</label>  
            </div>
          </div>
          ...
          <div class="col-lg-6 form-group">  
            <div class="icheck-primary d-inline">
              ...
              <label for="radioPrimary2">Village/Voter Check List</label>  
            </div>
          </div>
          <div class="col-lg-6 form-group">  
            <div class="icheck-primary d-inline">
          ...
          <div class="col-lg-6 form-group">  
            <div class="icheck-primary d-inline">
              ...
              <label for="radioPrimary4">Voter Not Mark (Complete MC)</label>  
            </div>
          </div> 
