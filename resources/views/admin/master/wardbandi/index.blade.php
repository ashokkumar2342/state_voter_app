...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h3>Ward Bandi (Voter Entry)</h3>
            </div>
        </div> 
    </div>
    <div class="card card-info">
        <div class="card-body">
            <form action="{{ route('admin.Master.WardBandiStore') }}" method="post"@if ($refreshdata == 1)select-triger="assembly_part_select_box,ward_select_box" @endif no-reset="true" class="add_form" reset-input-text="from_sr_no,to_sr_no">
            {{ csrf_field() }}
                <div class="row">
                    ...
                    <div class="col-lg-4 form-group">
                        ...
                        <span class="fa fa-asterisk"></span>
                        <select name="village" class="form-control select2" id="village_select_box" select2="true" data-table-new-without-pagination="ajax_data_table" onchange="callAjax(this,'{{ route('admin.Master.WardBandiFilter') }}','value_div_id')" required>
