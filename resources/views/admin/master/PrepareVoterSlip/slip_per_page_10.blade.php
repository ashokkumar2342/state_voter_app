		...
		<table width="100%">
			<tbody>
				...
				<tr>
					...
					<td style="font-size:16px;word-spacing:5px" colspan="3"><b>{{ $voterReport->name_l }}&nbsp;</b></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td style="font-size:16px;word-spacing:5px" colspan="3"><b>{{ $voterReport->father_name_l }}&nbsp;</b></td>
				</tr>
			</tbody>
		</table>
		<table width="100%">
