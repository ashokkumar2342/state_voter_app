...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h3>Last Voter Sr.No. (Ward Wise)</h3>
            </div>
            <div class="col-sm-6">
            ...
            <div class="card-body">
                <div class="row">  
                    ...
                    <div class="col-lg-4 form-group">
                        ...
                        <span class="fa fa-asterisk"></span>
                        <select name="village" class="form-control select2" id="village_select_box" onchange="callAjax(this,'{{ route('admin.last.voter.srno.ward.list') }}'+'?village='+this.value ,'last_voter_srno_list')">
                            <option selected disabled>Select MC</option>
                        </select>
                    </div>
                </div>
