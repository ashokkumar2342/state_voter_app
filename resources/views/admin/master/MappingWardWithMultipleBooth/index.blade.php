                        ...
                        <form action="{{ route('admin.Master.MappingWardWithMultipleBoothStore') }}" method="post" class="add_form" no-reset="true">
                            ...
                            <div class="row"> 
                                ...
                                <div class="col-lg-6 form-group">
                                    ...
                                    <span class="fa fa-asterisk"></span>
                                    <select name="ward" class="form-control" id="ward_select_box" duallistbox="true" onchange="callAjax(this,'{{ route('admin.Master.MappingWardWithMultipleBoothWardWiseBooth') }}'+'?ward_id='+this.value+'&village_id='+$('#village_select_box').val(),'booth_select_box')" required>
