  ...
  <div class="card card-danger"> 
    <div class="card-body">
      <div class="row"> 
        ...
        <select name="from_booth" class="form-control"  id="from_booth_select_box" onchange="callAjax(this,'{{ route('admin.Master.add.voter.with.ward.table') }}'+'?ward_id='++$('#from_ward_select_box').val()+'&booth_id='+this.value,'result_table')">
        ...
        <div class="col-lg-6 form-group" style="margin-top: 30px"> 
          <a href="#" class="btn btn-warning form-control" onclick="callPopupLarge(this,'{{ route('admin.Master.add.voter.with.ward.booth.report') }}'+'?village_id='+$('#village_select_box').val())">Report</a>
        </div>  
      </div> 
    </div>
  </div>
