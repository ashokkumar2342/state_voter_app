...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h3>Add/Shift Voters Ward (AC/Part No. Wise)</h3>
            </div>
            <div class="col-sm-6">
        ...
        <div class="card card-info"> 
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-12">
                            <form action="{{ route('admin.claim.obj.ac.part.srno.changeWardFormStore') }}" method="post" @if ($refreshdata == 1)
                                select-triger="assembly_part_select_box"
                            @endif  no-reset="true" class="add_form" reset-input-text="from_sr_no,to_sr_no">
                                {{ csrf_field() }}
                                <div class="card-body">
                                    <div class="row"> 
                                    ...
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <span class="fa fa-asterisk"></span>
                                        <select name="village" class="form-control select2" id="village_select_box" select2="true" onchange="callAjax(this,'{{ route('admin.claim.obj.ac.part.srno.changeWardForm') }}','value_div_id')">
