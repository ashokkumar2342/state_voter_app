    ...
    <div class="card-body">
      <div class="row">
        <div class="col-lg-6 form-group">
          ...
          <select name="data_list" id="data_list" class="form-control" required onchange="callAjax(this,'{{ route('admin.claim.obj.ac.part.srno.changeBoothTable') }}'+'?data_list_id='+$('#data_list').val()+'&part_id='+$('#assembly_part_select_box').val()+'&block_id='+$('#block_select_box').val(),'result_table');">
        ...
        <div class="col-lg-6 form-group">
          ...
          <select name="assembly_part" id="assembly_part_select_box" class="form-control select2" required onchange="callAjax(this,'{{ route('admin.claim.obj.ac.part.srno.changeBoothTable') }}'+'?data_list_id='+$('#data_list').val()+'&part_id='+$('#assembly_part_select_box').val()+'&block_id='+$('#block_select_box').val(),'result_table');">
        ...
        @if ($refreshdata == 0)
           <div class="col-lg-4 form-group"  style="margin-top: 30px"> 
            <button type="button" class="btn btn-default form-control" onclick="callAjax(this,'{{ route('admin.claim.obj.ac.part.srno.changeBoothTable') }}'+'?data_list_id='+$('#data_list').val()+'&part_id='+$('#assembly_part_select_box').val()+'&block_id='+$('#block_select_box').val(),'result_table');" style="background-color:#c2cad2"><i class="fa fa-refresh"></i> Refresh</button>
           </div>
