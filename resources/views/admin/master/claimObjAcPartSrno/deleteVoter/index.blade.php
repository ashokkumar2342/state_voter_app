...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h3>Delete Voters (AC/Part No. Wise)</h3>
            </div>
            <div class="col-sm-6">
        ...
        <div class="card card-info"> 
            <div class="card-body">
                <form action="{{ route('admin.claim.obj.ac.part.srno.deleteVoterStore') }}" method="post"@if ($refreshdata == 1)
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 form-group">
                        ...
                        <span class="fa fa-asterisk"></span>
                        <select name="village" class="form-control select2" id="village_select_box" select2="true" onchange="callAjax(this,'{{ route('admin.claim.obj.ac.part.srno.deleteVoterForm') }}','value_div_id')">
