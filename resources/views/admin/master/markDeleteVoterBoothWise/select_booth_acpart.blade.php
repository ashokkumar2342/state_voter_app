  ...
  <div class="card card-danger"> 
    <div class="card-body">
      ...
      <div class="col-lg-6 form-group">
        ...
        <select name="data_list" id="data_list" disabled class="form-control" required onchange="callAjax(this,'{{ route('admin.mark.deletebooth.voter.table') }}'+'?part_id='+$('#assembly_part_select_box').val()+'&village_id='+$('#village_select_box').val(),'result_table')">
      ...
      <div class="col-lg-12 form-group">
        <a class="btn btn-warning form-control" onclick="callPopupLarge(this,'{{ route('admin.mark.deletebooth.voter.report') }}'+'?village_id='+$('#village_select_box').val()+'&assembly_part='+$('#assembly_part_select_box').val()+'&data_list='+$('#data_list').val())">Report</a> 
      </div> 
      </div> 
    </div>
  </div>
