    ...
    <div class="card-header ui-sortable-handle" style="background: rgb(51, 102, 204);color: #fff;">
        ...
        <div class="card-tools">
            <ul class="nav nav-pills ml-auto">
                <li class="nav-item">
                    <button type="button" class="btn btn-sm btn-warning" onclick="callPopupLarge(this,'{{ route('admin.Master.WardBandiReport') }}'+'?village='+$('#village_select_box').val()+'&assembly_part='+$('#assembly_part_select_box').val()+'&ward='+$('#ward_select_box').val())">Report</button>
                </li>
            </ul>
        </div>
    </div>
