...
<section class="content-header">
    <div class="container-fluid">
        ...
        <div class="card card-info"> 
            <form action="{{ route('admin.Master.WardBandiWithBoothStore') }}" method="post" 
                @if ($refreshdata == 1)
                    select-triger="assembly_part_select_box,booth_select_box"
                @endif  no-reset="true" no-reset="true" class="add_form">
                {{ csrf_field() }}
                <div class="card-body">
                    <div class="row"> 
                        ...
                        <div class="col-lg-3 form-group">
                            ...
                            <span class="fa fa-asterisk"></span>
                            <select name="village" class="form-control select2" id="village_select_box" select2="true" onchange="callAjax(this,'{{ route('admin.Master.VillageWiseAssemblyWard') }}','value_div_id')" required>
