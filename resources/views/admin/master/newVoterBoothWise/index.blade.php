...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h3>Add New Voters (Booth Wise)</h3>
            </div>
            <div class="col-sm-6">
        ...
        <div class="card card-info"> 
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-12">
                            <form action="{{ route('admin.new.voter.booth.wise.store') }}" method="post" no-reset="true" class="add_form" reset-input-text="from_sr_no,to_sr_no" select-triger="data_list">
                                {{ csrf_field() }}
                                <div class="card-body">
                                    <div class="row"> 
                                    ...
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <span class="fa fa-asterisk"></span>
                                        <select name="village" class="form-control select2" id="village_select_box" select2="true" onchange="callAjax(this,'{{ route('admin.new.voter.booth.wise.form') }}','value_div_id')">
