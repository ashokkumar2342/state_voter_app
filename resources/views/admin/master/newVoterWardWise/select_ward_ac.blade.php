  ...
  <div class="card card-danger"> 
    <div class="card-body">
      ...
      <div class="col-lg-4 form-group">
        ...
        <select name="data_list" id="data_list" class="form-control" required onchange="callAjax(this,'{{ route('admin.new.voter.ward.wise.table') }}'+'?part_id='+$('#assembly_part_select_box').val(),'result_table')">
        ...
        <div class="col-lg-6 form-group" style="margin-top: 30px"> 
          <a class="btn btn-warning form-control" onclick="callPopupLarge(this,'{{ route('admin.new.voter.ward.wise.report') }}'+'?village_id='+$('#village_select_box').val()+'&ward_id='+$('#from_ward_select_box').val()+'&assembly_part='+$('#assembly_part_select_box').val()+'&data_list='+$('#data_list').val())">Report</a>
        </div>  
      </div> 
    </div>
  </div>
