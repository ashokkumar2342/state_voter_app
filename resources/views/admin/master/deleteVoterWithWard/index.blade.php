...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h3>Delete Voters (From Ward :: Draft Sr.No.)</h3>
            </div>
            <div class="col-sm-6">
        ...
        <div class="card card-info"> 
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-12">
                            <form action="{{ route('admin.Master.delete.voter.ward.submit') }}" method="post" no-reset="true" class="add_form" reset-input-text="from_sr_no,to_sr_no"  @if ($refreshdata == 1) select-triger="from_ward_select_box" @endif>
                                {{ csrf_field() }}
                                <div class="card-body">
                                    <div class="row"> 
                                    ...
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <span class="fa fa-asterisk"></span>
                                        <select name="village" class="form-control select2" id="village_select_box" select2="true" onchange="callAjax(this,'{{ route('admin.Master.delete.voter.ward.showform') }}','value_div_id')">
