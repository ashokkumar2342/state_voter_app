<div class="modal-dialog">
  <div class="modal-content">
    ...
    <div class="modal-body">
      <form action="{{ route('admin.Master.Assembly.store',$assembly[0]->id) }}" method="post" class="add_form" select-triger="district_select_box" button-click="btn_close">
        {{ csrf_field() }}
        <div class="card-body"> 
          <div class="form-group">
            ...
            <select name="district" class="form-control" required>
              ...
              <option value="{{ $District->id }}"{{ $assembly[0]->district_id==$District->id?'selected': '' }}>{{ $District->code }}--{{ $District->name_e }}</option>  
              @endforeach
            </select>
          </div> 
          <div class="form-group">
