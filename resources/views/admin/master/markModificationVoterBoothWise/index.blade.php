...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h3>Mark Modified Voters (Booth Wise)</h3>
            </div>
            <div class="col-sm-6">
                    ...
                    <div class="col-lg-12">
                        <div class="card-body">
                            ...
                            <div class="col-lg-3 form-group">
                                ...
                                <span class="fa fa-asterisk"></span>
                                <select name="village" class="form-control select2" id="village_select_box" select2="true" onchange="callAjax(this,'{{ route('admin.mark.modification.voter.booth.form') }}','value_div_id')">
