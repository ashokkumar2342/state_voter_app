<div class="modal-dialog modal-lg">
  <div class="modal-content">
    ...
    <div class="modal-body">
      <form action="{{ route('admin.VoterListMaster.store',$VoterListMaster[0]->id) }}" method="post" class="add_form" content-refresh="voter_list_master" button-click="btn_close" select-triger="block_select_box">
                {{ csrf_field() }} 
                <div class="row">
                    ...
                    <div class="col-lg-4 form-group">
                        <label for="exampleInputEmail1">Base Year</label>
                          ...
                          maxlength="4" value="{{ $VoterListMaster[0]->year_base }}" required onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                    </div>
                    <div class="col-lg-4 form-group">
                        <label for="exampleInputEmail1">Base Date</label>
                          <input type="text" name="base_date" class="form-control"
                          maxlength="20" value="{{ $VoterListMaster[0]->date_base }}" required>
                    </div>
                    <div class="col-lg-4 form-group">
                    ...
                    <div class="col-lg-4 form-group">
                        <label for="exampleInputEmail1">Remarks 1</label>
                          <input type="text" name="remarks2" class="form-control" maxlength="100" value="{{ $VoterListMaster[0]->remarks2 }}" required>
                    </div>
                    <div class="col-lg-4 form-group">
                        <label for="exampleInputEmail1">Remarks 2</label>
                          <input type="text" name="remarks3" class="form-control" maxlength="100" value="{{ $VoterListMaster[0]->remarks3 }}" required>
                    </div>
                     @php
