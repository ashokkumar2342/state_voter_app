            ...
            {{ csrf_field() }}
                <div class="row">
                    ...
                    <div class="col-lg-6 form-group">
                        ...
                        <span class="fa fa-asterisk"></span>
                        <select name="block" class="form-control select2" id="block_select_box" data-table-new-without-pagination="ajax_data_table" onchange="callAjax(this,'{{ route('admin.VoterListMaster.table') }}','result_div_id')">
