...
<div class="row"> 
 <div class="col-lg-6 form-group">
    ...
    <select name="district_id" class="form-control" multiselect-form="true" onchange="callAjax(this,'{{ route('admin.voter.districtWiseAssembly') }}','asembly_no_div')" select-triger="asembly_no_div">
 ...
 <div class="col-lg-6 form-group">
    ...
    <select name="ac_code" class="form-control" id="asembly_no_div" multiselect-form="true" onchange="callAjax(this,'{{ route('admin.database.conection.assemblyWisePartNo') }}','part_no_div')">
